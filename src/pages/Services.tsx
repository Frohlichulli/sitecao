  ...
  return (
    <div className="bg-brand-bg pt-20 md:pt-36 pb-10 md:pb-16 relative overflow-hidden">
        ...
        <header className="mb-10 md:mb-16 px-6">
          ...
          >
            <div className="mb-3 md:mb-4 flex items-center space-x-3">
              ...
              <span className="text-[10px] uppercase tracking-[0.5em] text-brand-dark/70 font-bold">Soluções para seu Pet</span>
            </div>
            ...
            <p className="text-brand-dark/95 text-xs md:text-sm uppercase tracking-[0.3em] max-w-2xl px-6 md:px-0 font-bold">
      ...
      <div className="container mx-auto px-6">
            ...
            >
              <div>
                <div className="flex justify-between items-start mb-6 md:mb-8">
                  ...
                  <div className="w-12 h-12 border border-brand-vibrant/20 rounded-full flex items-center justify-center text-brand-vibrant bg-brand-soft/30 transition-all">
                     {React.cloneElement(service.icon as React.ReactElement, { size: 20 })}
                  </div>
                </div>
                
                <h3 className="text-xl md:text-2xl font-extrabold uppercase tracking-tight text-brand-dark mb-3 underline underline-offset-[8px] decoration-brand-soft">{service.title}</h3>
                <p className="text-brand-dark/90 text-sm md:text-base leading-snug mb-6 font-medium">
                  {service.desc}
                </p>
              </div>
        ...
        {/* Info Box */}
        <div className="mt-12 md:mt-16 p-8 md:p-12 bg-white rounded-[32px] text-center border border-brand-dark/5 shadow-md max-w-4xl mx-auto space-y-4">
          <h2 className="text-brand-dark text-2xl md:text-4xl font-black uppercase tracking-tighter leading-none">Não sabe por onde começar?</h2>
          <p className="text-brand-dark/80 text-xs md:text-sm max-w-2xl mx-auto leading-snug font-medium">Oferecemos uma avaliação gratuita para diagnosticar o comportamento do seu pet e sugerir o melhor plano.</p>
          <div className="pt-2">
            <MotionLink 
              to="/avaliacao" 
